...
public static class DarkMode
{
    ...
    {
        private static void Postfix(HudManager __instnace)
        {
            if (!ModConfig.DarkMode.Value) return;
            __instnace.MapButton.inactiveSprites.GetComponent<SpriteRenderer>().color = new Color(0.5f, 0.5f, 0.5f);
            __instnace.MapButton.activeSprites.GetComponent<SpriteRenderer>().color = new Color(0.5f, 0.5f, 0.5f);
            __instnace.MapButton.selectedSprites.GetComponent<SpriteRenderer>().color = new Color(0.5f, 0.5f, 0.5f);
            __instnace.MapButton.transform.FindChild("Background").GetComponent<SpriteRenderer>().color = new Color(0.5f, 0.5f, 0.5f);

            __instnace.SettingsButton.GetComponent<PassiveButton>().inactiveSprites.GetComponent<SpriteRenderer>().color = new Color(0.5f, 0.5f, 0.5f);
            __instnace.SettingsButton.GetComponent<PassiveButton>().activeSprites.GetComponent<SpriteRenderer>().color = new Color(0.5f, 0.5f, 0.5f);
            __instnace.SettingsButton.GetComponent<PassiveButton>().selectedSprites.GetComponent<SpriteRenderer>().color = new Color(0.5f, 0.5f, 0.5f);
            __instnace.SettingsButton.transform.FindChild("Background").GetComponent<SpriteRenderer>().color = new Color(0.5f, 0.5f, 0.5f);
        }
    }
